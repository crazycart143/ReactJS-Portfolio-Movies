      ...
      <body className="overflow-x-hidden scrollbar-none" id="root">
        ...
        <main className="grid w-full h-full grid-cols-nav1">
          ...
          <div className="w-full h-full mx-5 mt-10 bg-white">
            {popular?.length > 0 ? (
              <>
                <div className="mx-5 h-[450px] w-[91.5%] mb-[5%] mt-[5%] relative">
                  <CardMedia
                    sx={{ height: 450, width: 1180, filter: "brightness(50%)" }}
                    //to destructure non array object
                    image={
                ...
                <div class="flex flex-wrap justify-start items-start text-center w-[95%] mx-[5.5%]">
                  {filtered.map((movie) => (
