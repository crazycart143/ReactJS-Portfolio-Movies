...
duration-300 hover:scale-105 h-[50px] mb-[400px] mr-[65px] relative"
    >
      <CardMedia
      ...
      <Typography className="text-[#212121] flex text-center h-[80px] text-[] items-start justify-center mt-3 text-ellipsis">
        {movie.title}
      </Typography>
    </div>
  );
